...
# User Menu Button
user_menu_btn = ttk.Button(button_frame, text="User Management", style='Menu.TButton', command=open_user_menu)
user_menu_btn.pack(side=tk.LEFT, padx=20, pady=10)

# Stock Menu Button
stock_menu_btn = ttk.Button(button_frame, text="Stock Management", style='Menu.TButton', command=open_stock_menu)
stock_menu_btn.pack(side=tk.LEFT, padx=20, pady=10)

# Logout Button
logout_btn = ttk.Button(root, text="Logout", style='Logout.TButton', command=logout)
